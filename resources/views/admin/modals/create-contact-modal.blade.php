<div id="create-card-modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="create-contact-form" action="#" method="get">
                <div class="modal-header">
                    <h5 class="modal-title">Добавление карточки</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button id="create-contact-button" type="button" class="btn btn-primary">Сохранить</button>
                </div>
            </form>
